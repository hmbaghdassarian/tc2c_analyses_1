...
import numpy as np
# implemented in tensorly directly, and copied here commit: 90338c330e81cd9a2d12ed4508210ac538c3c567
...
def correlation_index(factors_1: list, factors_2: list, tol: float = 5e-16, method : str = 'stacked') -> float:
...
def _compute_correlation_index(x1 : list, x2 : list, tol : float = 5e-16) -> float:
    ...
    c_prod_mtx = tl.abs(np.matmul(tl.conj(tl.transpose(x1)), x2))
